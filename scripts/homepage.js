const root = Vue.createApp({
    ...
    data() {
        return { 
            ...
            guides: "GUIDES",
            guides_navigate_title: "How To Carry Out My Responsibilities",
            guides_navigate_desc: "Find out more about what you need to do as a helper and other soft skills.",
